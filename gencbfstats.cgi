...
#itfds-utv01
#scriptpath = "/var/www/cgi-bin/cbf/";
...
inputMale = float(inputData['male'])
allMale = allData['male']
male = (inputMale / allMale) * normSize
maleSpruce = "%.2f" % male

inputFemale = float(inputData['female'])
...
#        plusminus = getPRloglikelihood(arguments)
        plusminus = ((words + noHits) * (words + totDecadeWords)) / (words + noHits + totDecadeWords + noWords)
        plusminus = "%.1f" % plusminus
        statsDict['ExpValues'][decade] = str(plusminus)
        arg1 = str(words)
        arg2 = str(totDecadeWords)
        arg3 = str(noHits)
        arg4 = str(noWords)
#        print(arg1, arg2, arg3, arg4, end="<br/>")
